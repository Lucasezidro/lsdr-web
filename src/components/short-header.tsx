...
export function ShortHeader({ isAuthenticated }: HeaderProps) {
                ...
                {isAuthenticated && data && (
                  <>
                    {!organizationId ? (
                      ...
                      <li>
                        <a href={`/organizations/${organizationId}`} className="text-zinc-400 font-bold hover:text-cyan-500 flex items-center gap-2">
                          Acessar organização
                          <Building />
                        </a>
                      </li>
